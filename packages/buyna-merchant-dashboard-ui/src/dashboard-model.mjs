export const DASHBOARD_NAVIGATION=Object.freeze([
  ...
  {key:'paymentSettings',label:'支付设置',href:'/seller/settings/payment',icon:'◇'},
]);
...
export const DASHBOARD_PAGES=Object.freeze({
  ...
  paymentSettings:{sections:['connectionStatus','enabledMethods','notifyUrl','returnUrl','merchantPortal'],actions:['validateConfiguration'],states:['loading','unconfigured','configured','error','permission']},
});
