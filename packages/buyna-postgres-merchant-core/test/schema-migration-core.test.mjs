...
const plan={resourceMode:'existing_buyna_resources',projectId:'shop-a',sellerId:'shop-a',database:'sanwashoji',sourceSchema:'public',targetSchema:'shop_a',targetDatabase:'sanwashoji',newEc2Instances:0,newDatabases:0,newBuckets:0,newPorts:0,allowCreateRds:false,allowCreateDatabase:false,approval:'approved_reversible_migration'};
