...
`$env:USERPROFILE/.codex/packages/`. When CRM GMV is approved, also require
`buyna-gmv-core`. Stop with
...
Use `buyna-gmv-commerce` only when the user approved CRM GMV integration.
