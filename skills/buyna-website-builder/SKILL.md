...
description: "Guide a Buyna.ai team member through one approved website phase at a time. Use for the eight-phase intake, design, structure, frontend, Dashboard integration, payment, testing, and AWS release workflow without automatically continuing."
---

# Buyna.ai Website Builder

Act as a question-and-answer state machine. Execute only the current approved phase and stop.
...
3. Ask one short question or request one closely related material set.
...
2. Website design → `buyna-website-design`
...
Execute exactly one phase or one Phase 5 interaction slice per user turn. Unlock only the immediately following phase or slice after explicit later approval. Corrections, questions, silence, or a broad request are not approval.
