...
- Without a work package, keep each run to one gate or compatible slice. With an approved work package, continue across ready included gates after each gate records valid delivery evidence.
